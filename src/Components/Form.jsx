...
const Form = () => {
    return (
        <form className='px-10 py-10'>
            ...
            <div className='lg:flex w-full gap-10 my-4'>
                <div className='w-1/2'>
                    <label className=' text-black-medium font-semibold text-black-medium  py-2 block'>Email</label>
            ...
            <div className='py-3'>
                ...
                <div className='flex  py-3'>
                    <input className='me-2' type='checkbox' /> <span className='me-12  text-gray-800'>General Inquiry</span>
                    <input className='me-2' type='checkbox' /> <span className='me-12  text-gray-800'>Test Packages</span>
                    <input className='me-2' type='checkbox' />  <span className='me-12  text-gray-800'>Help & Support</span>
                    <input className='me-2' type='checkbox' /> <span className='me-12  text-gray-800'>Report </span>
