    ...
    <section className='flex flex-col-reverse lg:flex-row gap-5 items-center px-2 lg:px-20'>
      <div className='  w-full lg:w-[55%]'>
        ...
        <div className='flex flex-wrap lg:flex-grow-0 items-center gap-1 lg:gap-2 py-12'>
          <Link to={'/scan'} className='flex  flex-grow lg:flex-grow-0 items-center gap-2 lg:gap-4 font-[600] lg:font-bold text-[12px] lg:text-lg bg-Primary text-white px-1 lg:px-6 py-2 lg:py-3 rounded-md lg:rounded-xl'>
